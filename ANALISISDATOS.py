...
def analisis2():
    ...
    while (Largo > 11 and f<20):
        ...
        if precioactual > precioanterior:
            tabla.iat[Largo - 10, 1] = 1
        if precioactual < precioanterior:
            tabla.iat[Largo - 10, 1] = 2
        if precioactual == precioanterior:
            tabla.iat[Largo - 10, 1] = 0
        # para 3 m
        precioactual = float(tabla.iloc[Largo, 0])
    ...
    while (Largo > 3 and a<30):
        ...
        Datos5m = {'0': Dato5m, '1': MRSI, '2': MRSIP, '3': MESTOCASTICO, '4': MESTOCASTICOP, '5': MMACD, '6': MMACDP,
                   '7': MIMDM, '8': MIMDMP, '9': MICPB, '10': MICPBP, '11': MOA, '12': MOAP, '13': MRSIR, '14': MRSIRP,
                   '15': MWilliams, '16': MWilliamsP, '17': MOU, '18': MOUP,
                   '19': MVOLP, '20': MVOLP, '21': Hora, '22': Dato3m, '23': Dato35m, '24': Dato4m, '25': Dato45m}
