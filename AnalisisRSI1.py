...
def AnalisisRSI1():
    ...
    tabla = tablaleida5M
    Largo = tabla.shape[0]
    tablaRSI = pandas.read_csv("convinacionesRSI1.csv")
    ...
    tablaRSI.to_csv(r'C:\Users\Nacho\Desktop\Desarrollos\VamosQueSale\convinacionesRSI1.csv', index=False, header=True)
