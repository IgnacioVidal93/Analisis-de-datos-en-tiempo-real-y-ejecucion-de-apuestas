...
def AnalisisIMDM1():
    ...
    tabla = tablaleida5M
    Largo = tabla.shape[0]
    tablaC1= pandas.read_csv("convinacionesIMDM1.csv")
                ...
                while m<2:
                    ...
                    if D1 == r and D2 == e and VOLP == m:
                        ...
                        while Acierto < 9:
                            ...
                            Porsentaje += 2
                            Dato += 1
    tablaC1.to_csv(r'C:\Users\Nacho\Desktop\Desarrollos\VamosQueSale\convinacionesIMDM1.csv', index=False, header=True)
